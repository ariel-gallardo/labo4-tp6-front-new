...
export const Home = () => {
    return (
        <div className="d-flex flex-column Home justify-content-center">
            ...
            <p className="text-white mt-lg-2 text-center Frase">Musical Hendrix es una tienda de instrumentos musicales con ya más de 15 años de experiencia. Tenemos el
